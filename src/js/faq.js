...
function showTab(index) {
  ...
  this.classList.add('js_dke_active');
  this.firstElementChild.setAttribute('aria-selected', true);
  tabsFaq[index].classList.add('js_dke_active');
...
function closeTab() {
  conntrolBtns[currentOpenedTab].classList.remove('js_dke_active');
  conntrolBtns[currentOpenedTab].firstElementChild.setAttribute('aria-selected', false);
  tabsFaq[currentOpenedTab].classList.remove('js_dke_active');
}
